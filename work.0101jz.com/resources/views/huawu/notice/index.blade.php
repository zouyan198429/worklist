...
@section('content')
	...
	<div class="mm">
		...
		<table id="dynamic-table"  class="table2">
			...
			{{--
			<tr>
				<td class="tl" ><a href="{{ url('huawu/notice/info') }}" ><i class="fa fa-angle-right fa-fw" aria-hidden="true"></i> 企业品牌推广的战略选择</a></td>
				<td>★★</td>
				<td>话务</td>
				<td>张兰兰</td>
				<td>2015-04-22</td>
...
@push('footlast')
	<script type="text/javascript">
        ...
        var AJAX_URL = "{{ url('api/huawu/notice/ajax_alist') }}";//ajax请求的url
        ...
        var EXPORT_EXCEL_URL = "{{ url('huawu/notice/export') }}";//导出EXCEL地址
        var IMPORT_EXCEL_TEMPLATE_URL = "{{ url('huawu/notice/import_template') }}";//导入EXCEL模版地址
        var IMPORT_EXCEL_URL = "{{ url('api/huawu/notice/import') }}";//导入EXCEL地址
        var IMPORT_EXCEL_CLASS = "import_file";// 导入EXCEL的file的class

	</script>
	<script src="{{asset('js/common/list.js')}}"></script>
	<script src="{{ asset('js/huawu/lanmu/notice.js') }}"  type="text/javascript"></script>
@endpush