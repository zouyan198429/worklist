...
@push('footlast')
	<script type="text/javascript">
        ...
        const EXPORT_EXCEL_URL = ""; // {{ url('manage/work_type/add/0') }}"; //"{{ url('api/manage/work_type/export') }}";//导出EXCEL地址
        const IMPORT_EXCEL_URL =""; // "{{ url('manage/work_type/add/0') }}"; //"{{ url('api/manage/work_type/import') }}";//导入EXCEL地址
