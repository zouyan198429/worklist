...
@section('content')
	...
	<div id="crumb"><i class="fa fa-reorder fa-fw" aria-hidden="true"></i> 添加反馈类型</div>
	<div class="mm">
...
@push('footlast')
	<script type="text/javascript">
        const SAVE_URL = "{{ url('api/admin/problem_type/ajax_save') }}";// ajax保存记录地址
        const LIST_URL = "{{url('admin/problem_type')}}";//保存成功后跳转到的地址
	</script>
	<script src="{{ asset('/js/admin/lanmu/problem_type_edit.js') }}"  type="text/javascript"></script>
@endpush