...
@section('content')
	...
	<div class="mm">
		<div class="mmhead" id=" ">
			<div class="tabbox fl" style=" width:400px; float:left;" ><a href="{{ url('admin/subject/add') }}" class="on">添加试题</a> <a href="#" >导入试题</a> </div>
		...
		<table class="table2">
			...
			<tr>
				...
				<td>2018-05-21</td>
				<td>张栋</td>
				<td><a href="{{ url('admin/subject/add') }}" class="btn" >修改</a></td>
			</tr>
			<tr>
				<td><input type="checkbox" name="vehicle" value="11" /></td>
				<td>您被分到一个单位当领导，想提出一些解决工...</td>
