...
@push('footlast')
	<script type="text/javascript">
        var INIT_EXAM_URL = "{{ url('api/m/exam/ajax_init_exam') }}";// ajax在线考试初始化地址
        var SAVE_URL = "{{ url('api/m/exam/doing_ajax_save') }}";// ajax保存记录地址
        var EXAM_STAFF_ID = '{{ $id or 0 }}';// 考试员工表id
        var WIN_URL = "{{ url('m/exam/win') }}/" + EXAM_STAFF_ID;// 交卷后跳转地址
	...
	<script src="{{ asset('/js/m/lanmu/exam_doing.js') }}"  type="text/javascript"></script>
@endpush