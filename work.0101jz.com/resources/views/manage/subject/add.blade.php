...
@push('footlast')
	<script type="text/javascript">
        var SAVE_URL = "{{ url('api/manage/subject/ajax_save') }}";// ajax保存记录地址
        var LIST_URL = "{{url('manage/subject')}}";//保存成功后跳转到的地址
	...
	<script src="{{ asset('/js/manage/lanmu/subject_edit.js') }}"  type="text/javascript"></script>
