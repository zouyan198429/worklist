...
--}}
	...
	<div id='myUploader' class="uploader" data-ride="uploader" data-url="{{ url('api/manage/upload') }}">
		<div class="uploader-message text-center">
			<div class="content"></div>
			<button type="button" class="close">×</button>
		</div>
	...
	<script>
        ...
        $(function(){
            ...
            $('#myUploader').uploader({
                ...
                url: "{{ url('api/manage/upload') }}",  // 文件上传提交地址 'your/file/upload/url'
                ...
                deleteActionOnDone: function(file, doRemoveFile){
                    ...
                    var index_query = layer.confirm('您确定删除吗？不可恢复!', {
                        ...
                        $.ajax({
                            'type' : 'POST',
                            'url' : '{{ url('api/manage/upload/ajax_del') }}',
                            'data' : data,
                            'dataType' : 'json',
