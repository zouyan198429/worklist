    ...
    <div id="userinfo">
        <div class="dropdown">
            ...
            <ul class="dropdown-content">
                <li><a href="{{ url('manage/info') }}" >我的帐号</a></li>
                <li><a href="{{ url('manage/password') }}" >修改密码</a></li>
            </ul>
        </div>
        <span class="quit"><a href="{{ url('manage/' . $baseArr ['company_id'] . '/logout') }}"><i class="fa fa-power-off fa-fw" aria-hidden="true"></i>退出</a></span></div>
</div>
