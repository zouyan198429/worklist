...
@push('footlast')
	<script type="text/javascript">
        const SAVE_URL = "{{ url('api/manage/lore/ajax_save') }}";// ajax保存记录地址
        const LIST_URL = "{{url('manage/lore')}}";//保存成功后跳转到的地址
	</script>
	<script src="{{ asset('/js/manage/lanmu/lore_edit.js') }}"  type="text/javascript"></script>
@endpush