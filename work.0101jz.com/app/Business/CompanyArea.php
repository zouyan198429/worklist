 ...
 *
 */
class CompanyArea extends BaseBusiness
{
    ...
    public static function getChildListKeyVal(Request $request, Controller $controller, $id, $oprateBit = 2 + 4, $notLog = 0){
        ...
        return Tool::formatArrKeyVal($department_list, 'id', 'area_name');
    }
    ...
    public static function getChildList(Request $request, Controller $controller, $id, $oprateBit = 2 + 4, $notLog = 0){
        ...
        $queryParams = [
            ...
            'select' => [
                'id', 'company_id', 'area_parent_id', 'area_name', 'sort_num', 'ids'
...
//        $result['data_list'] = $data_list;
        ...
        $format_data_list = [];
        foreach($resultDatas as $v){
            $parent_id = $v['area_parent_id'];
            if($parent_id > 0 ){
                $v['street_name'] =  $v['area_name'];
                $v['area_name'] = "";
            }else{
                $v['street_name']  = "";
            }
